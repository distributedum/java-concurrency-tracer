import pt.sd.trace.TracedReadWriteLock;

import pt.sd.trace.Tracer;

/**
 * Readers/writers — WRAPPERS PATH. Uses TracedReadWriteLock, with an explicit name.
 *
 *
 *   javac -d out pt/sd/trace/*.java demo/ReadersWritersDemo.java
 *   java -cp out ReadersWritersDemo
 *
...
public class ReadersWritersDemo {
    ...
    private final TracedReadWriteLock rw = new TracedReadWriteLock("data", true);
    private int value = 0;
    ...
    public static void main(String[] args) throws Exception {
        ReadersWritersDemo d = new ReadersWritersDemo();
